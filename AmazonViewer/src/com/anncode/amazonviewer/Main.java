...
public class Main {
	...
	public static void showChapters(ArrayList<Chapter> chaptersOfSerieSelected) {
		...
		do {
			...
			AtomicInteger atomicInteger = new AtomicInteger(1);
			chaptersOfSerieSelected.forEach(ch -> System.out.println(atomicInteger.getAndIncrement() + ". " + ch.getTitle() + " Visto: " + ch.isViewed()));
	...
	public static void showBooks() {
		...
		do {
			...
			AtomicInteger atomicInteger = new AtomicInteger(1);
			books.forEach(b -> System.out.println(atomicInteger.getAndIncrement() + ". " + b.getTitle() + " Leido: " + b.isReaded()));
